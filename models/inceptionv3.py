...
# ===============================================================
# Model Definition: InceptionV3 + Clinical/Morphometric Data
# ===============================================================
...
def main():
    ...
    results_dir = "results/multimodal_inceptionv3_srbcn"
    ...
    for epoch in range(100):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(
                model.state_dict(),
                os.path.join(results_dir, "best_multimodal_inceptionv3_srbcn.pt")
            )
